...
description: >
  Token budget management for Codex sessions. Teaches how to minimize
  context consumption using MCP-first navigation, lazy loading, subagent
  isolation, and strategic file reading. Keeps Codex effective throughout
  ...
  Codex starts forgetting earlier context, or when planning how to explore
