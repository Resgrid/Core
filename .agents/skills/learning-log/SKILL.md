...
description: >
  ...
  .Codex/learning-log.md. Load this skill when Codex discovers something
...
Each entry follows a consistent structure in `.Codex/learning-log.md`:
...
.Codex/learning-log.md (this skill):
...
.Codex/handoff.md (via wrap-up-ritual):
...
.Codex/learning-log.md grows to 500 lines
...
| User corrected Codex's code | Don't log — use `self-correction-loop` for MEMORY.md |
