...
description: >
  ...
  "session start", "session end", "handoff", "context", "resume", or when Codex
...
STEP 3: Write Handoff
  → Write .Codex/handoff.md using the Handoff File Template (see below)
...
STEP 5: Update Instincts
  ...
  → Update confidence scores in .Codex/instincts.md
  → Promote any instincts that reached 0.9 (via instinct-system)

STEP 6: Confirm
  "Session wrapped up:
   - Handoff written to .Codex/handoff.md
...
.Codex/handoff.md      Session     Overwritten      Pass state between sessions
MEMORY.md               Project     Permanent        Store confirmed rules
.Codex/instincts.md    Project     Evolving         Track emerging patterns
...
The standard format for `.Codex/handoff.md`:
...
When no context files exist (brand new project or first Codex session):
...
When the handoff might be read by a different developer or Codex session:

```
ENHANCED HANDOFF (add when multiple developers use Codex on the project):
...
*Session starts*
Codex: "How can I help you today?"
*User: "Continue the order validation work"*
Codex: "What order validation work? Can you tell me what files to look at?"
*User wastes 5 minutes re-explaining*

# GOOD — loading context automatically
*Session starts*
Codex: "Last session completed CreateOrder validation. Pending: UpdateOrder
...
Codex: "You're welcome! Happy to help anytime."
*Next session starts from scratch*

# GOOD — capture before closing
User: "Thanks, that's all for today!"
Codex: "Before we wrap up, let me save our progress to .Codex/handoff.md
...
Codex: "Let me check diagnostics..." *tool fails*
Codex: "Let me find the symbol..." *tool fails*
Codex: "I'll just read the files manually" *misses project-wide context*

# GOOD — detect solution on start, verify MCP connectivity
*Session start*
Codex: "Detected solution at src/MyApp.slnx. MCP tools connected.
