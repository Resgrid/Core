...
namespace Resgrid.Model.Services
{
	...
	public interface IActionLogsService
	{
		...
		/// <param name="cancellationToken">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
		/// <param name="autoGenerated">True when the status changes are from an automated or bulk process (i.e. scheduled or department-wide reset) and should not generate user notifications.</param>
