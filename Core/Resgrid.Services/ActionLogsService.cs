...
namespace Resgrid.Services
{
	public class ActionLogsService : IActionLogsService
	{
		...
		public async Task<bool> SaveAllActionLogsAsync(List<ActionLog> actionLogs, CancellationToken cancellationToken = default(CancellationToken), bool autoGenerated = false)
		{
