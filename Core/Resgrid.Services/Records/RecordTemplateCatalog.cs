...
namespace Resgrid.Services.Records
{
	...
	public static partial class RecordTemplateCatalog
	{
		...
		{
			var pack = new RecordTemplatePack { Key = "pack.mutual-aid", Name = "Mutual Aid and Deployment Pack", Category = "Mutual aid", IsPreview = false, Description = "External deployment orders, resource movements, daily activity and return-to-home-unit closeout. Manage operations in Workforce & Business Ops; retain evidence and generate read-only reports in RMS. The external ordering system remains authoritative.",
