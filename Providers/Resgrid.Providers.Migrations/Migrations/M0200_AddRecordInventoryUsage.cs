...
{
	[Migration(200)]
	public class M0200_AddRecordInventoryUsage : Migration
	{
		...
		public override void Down()
		{
			...
			Execute.Sql("IF EXISTS (SELECT 1 FROM RecordInventoryUsages) THROW 51000, 'Inventory usage must be exported and removed through the authorized retention process before rollback.', 1;");
