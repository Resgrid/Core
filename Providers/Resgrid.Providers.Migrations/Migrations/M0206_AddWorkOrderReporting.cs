...
{
    [Migration(206)]
    public class M0206_AddWorkOrderReporting : Migration
    {
        ...
        public override void Up()
        {
            Create.Table(N("WorkOrderReportSnapshots"))
                ...
                .WithColumn(N("RecordedOn")).AsDateTime2().NotNullable()
                ...
                .WithColumn(N("StartedOn")).AsDateTime2().Nullable()
                .WithColumn(N("CompletedOn")).AsDateTime2().Nullable()
                .WithColumn(N("ClosedOn")).AsDateTime2().Nullable();
        ...
        {
            Execute.Sql("IF EXISTS (SELECT 1 FROM WorkOrderReportSnapshots) THROW 51000, 'Readiness evidence requires authorized retention before rollback.', 1;");
