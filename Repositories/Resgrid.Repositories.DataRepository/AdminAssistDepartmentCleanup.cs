...
namespace Resgrid.Repositories.DataRepository
{
	...
	public static class AdminAssistDepartmentCleanup
	{
		public static async Task DeleteWithinTransactionAsync(DbConnection connection, DbTransaction transaction, int departmentId, DatabaseTypes type, CancellationToken ct = default)
		{
			...
			foreach (var table in new[] { "AdminAssistDiagnosticRuns", "AdminAssistDiagnosticLeases", "AiGenerations", "AiUsageLedger", "AdminAssistConversations", "DepartmentAiConfigs", "AdminAssistDispatchTraces", "AdminAssistFindings", "AdminAssistDailySummaries", "AdminAssistPreferences", "AdminAssistLearning", "AdminAssistHistory", "AdminAssistWorkerStates", "AdminAssistWorkspaces", "AdminAssistConfigurationRevisions" })
			{
