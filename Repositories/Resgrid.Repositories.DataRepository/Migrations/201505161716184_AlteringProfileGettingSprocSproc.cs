namespace Resgrid.Repositories.DataRepository.Migrations
{
    ...
    public partial class AlteringProfileGettingSprocSproc : DbMigration
    {
        public override void Up()
        {
					Sql(@"	ALTER FUNCTION [dbo].[GetProperty] (
										...
										SELECT @PropPos = PATINDEX('%:'+ @PropertyName +':%', @Names)
										...
										ELSE
										BEGIN
										SET @PropPos = @PropPos + LEN(@PropertyName) + 2
