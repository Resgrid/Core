...
{
	public class PersonnelRoleUsersRepository : AuditedConfigurationRepository<PersonnelRoleUser>, IPersonnelRoleUsersRepository
	{
		...
		public PersonnelRoleUsersRepository(IConnectionProvider connectionProvider, SqlConfiguration sqlConfiguration, IUnitOfWork unitOfWork, IQueryFactory queryFactory, Resgrid.Model.AdminAssist.IConfigurationChangeJournal configurationJournal = null)
