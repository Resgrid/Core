...
{
	public class SelectCmdRolePersonnelRolesByCommandIdQuery : ISelectQuery
	{
		private readonly SqlConfiguration _sqlConfiguration;
		public SelectCmdRolePersonnelRolesByCommandIdQuery(SqlConfiguration sqlConfiguration)
		{
		...
		{
			var query = _sqlConfiguration.SelectCmdRolePersonnelRolesByCommandIdQuery
