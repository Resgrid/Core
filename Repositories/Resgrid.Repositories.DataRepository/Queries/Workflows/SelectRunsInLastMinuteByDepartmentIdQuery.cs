...
namespace Resgrid.Repositories.DataRepository.Queries.Workflows
{
	public class SelectRunsInLastMinuteByDepartmentIdQuery : ISelectQuery
	{
		...
		public string GetQuery() =>
			$"SELECT * FROM {_sqlConfiguration.SchemaName}.[WorkflowRuns] WHERE [DepartmentId] = {_sqlConfiguration.ParameterNotation}DepartmentId AND [QueuedOn] >= {_sqlConfiguration.ParameterNotation}SinceTime";
