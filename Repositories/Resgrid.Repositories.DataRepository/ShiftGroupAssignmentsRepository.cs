...
{
	public class ShiftGroupAssignmentsRepository : AuditedConfigurationRepository<ShiftGroupAssignment>, IShiftGroupAssignmentsRepository
	{
		...
		public ShiftGroupAssignmentsRepository(IConnectionProvider connectionProvider, SqlConfiguration sqlConfiguration, IUnitOfWork unitOfWork, IQueryFactory queryFactory, Resgrid.Model.AdminAssist.IConfigurationChangeJournal configurationJournal = null)
