...
namespace Resgrid.Repositories.DataRepository
{
	public class ShiftSignupRepository : RepositoryBase<ShiftSignup>, IShiftSignupRepository
	{
		...
		public async Task<IEnumerable<ShiftSignup>> GetShiftSignupsByDepartmentIdAndDateRangeAsync(int departmentId, DateTime startDate, DateTime endDate)
		{
			try
			{
				var selectFunction = new Func<DbConnection, Task<IEnumerable<ShiftSignup>>>(async x =>
				{
					...
					var query = _queryFactory.GetQuery<SelectShiftSignupsByDepartmentIdAndDateRangeQuery>();
