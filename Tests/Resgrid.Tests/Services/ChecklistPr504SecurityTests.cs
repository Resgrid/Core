...
namespace Resgrid.Tests.Services
{
	...
	public partial class ChecklistEventDeliveryTests
	{
		...
		public void Readiness_trigger_membership_cannot_be_replaced_through_the_public_collection()
		{
			...
			ChecklistWorkflowPayload.Triggers.Should().Equal(67, 68, 69, 70, 71, 72, 164, 165, 73, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 22, 58, 59, 60, 61, 62, 63, 64, 65, 66, 166, 188);
