	...
	public partial class GdprExportProtectedDataTests
	{
		...
		public void SetUp()
		{
			...
			_service = new GdprDataExportService(_repository.Object, _userProfileService.Object,
				...
				new Lazy<IReadinessHistoryProtectionService>(() => new ReadinessHistoryProtectionService(Mock.Of<IProtectedWriteService>(), Mock.Of<IDepartmentDataProtectionService>())), checklistReminders.Object, EmptyWorkOrders(), EmptyInventory());
		}
