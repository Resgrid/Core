...
namespace Resgrid.Tests.Services
{
	...
	public partial class WorkOrderDatabaseTests
	{
		...
		public async Task CreateIsolatedDatabaseAndMigrate()
		{
            ...
            await db.ExecuteAsync($"CREATE TABLE {Q("InventoryTransactions")} ({Q("Id")} varchar(36) PRIMARY KEY, {Q("DepartmentId")} int NOT NULL);");
