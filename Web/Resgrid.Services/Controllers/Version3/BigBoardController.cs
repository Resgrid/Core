...
namespace Resgrid.Web.Services.Controllers.Version3
{
	...
	public class BigBoardController : V3AuthenticatedApiControllerbase
	{
		...
		public List<CallViewModel> GetCalls()
		{
			...
			var calls = _callsService.GetActiveCallsByDepartment(DepartmentId);
			var usersNames = _departmentsService.GetAllPersonnelNamesForDepartment(DepartmentId);
			...
			foreach (var call in calls)
			{
				...
				{
					var profile = ProfileBase.Create(call.ReportingUser.UserName, true);
					name = profile.GetPropertyValue("Name") as string;
				}
		...
		public BigBoardMapModel GetMap()
		{
			var department = _departmentsService.GetDepartmentById(DepartmentId, false);
			var stations = _departmentGroupsService.GetAllStationGroupsForDepartment(DepartmentId);
			...
			var personnelViewModels = GetPersonnelStatuses();
