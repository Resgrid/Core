...
namespace Resgrid.Web.Services.Controllers.v4
{
	...
	public class DeploymentsController : V4AuthenticatedApiControllerbase
	{
		...
		internal static DeploymentAttachmentData MapAttachment(DeploymentAttachment a) => new DeploymentAttachmentData { Id = a.DeploymentAttachmentId, DeploymentId = a.DeploymentId, AttachmentType = a.AttachmentType, Name = a.Name, FileName = a.FileName, FileType = a.FileType, FileSize = a.FileSize, IsProtected = a.IsProtected, AddedOn = a.AddedOn, AddedByUserId = a.AddedByUserId };
