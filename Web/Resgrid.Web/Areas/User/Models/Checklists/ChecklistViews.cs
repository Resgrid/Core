...
{
	public class ChecklistIndexView { public List<ChecklistDefinitionView> Definitions { get; set; } public bool HasMore { get; set; } public bool CanManage { get; set; } public int Page { get; set; } }
	public class ChecklistEditView { public bool AssetsAvailable { get; set; } public string Id { get; set; } public int Revision { get; set; } public ChecklistForm Form { get; set; } }
