...
namespace Resgrid.Web.Areas.User.Models.WorkOrders
{
	...
	public sealed class WorkOrderEditView { public string Id { get; set; } public WorkOrderInput Input { get; set; } public WorkOrderChoices Choices { get; set; } public bool CanManage { get; set; } }
	...
	public sealed class WorkOrderReportView { public WorkOrderReportQuery Query { get; set; } public WorkOrderStats Stats { get; set; } public WorkOrderHistoryPage History { get; set; } public WorkOrderChoices Choices { get; set; } public bool CanWrite { get; set; } }
	public sealed class WorkOrderLockedView { public WorkOrderReportQuery Query { get; set; } = new(); public WorkOrderFilter Filter { get; set; } = new WorkOrderFilter(); public string Page { get; set; } public string Id { get; set; } }
