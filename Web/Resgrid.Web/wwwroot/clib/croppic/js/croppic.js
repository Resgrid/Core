	...
	Croppic.prototype = {
		...
		crop:function(){
			...
			if(typeof FormData == 'undefined'){
				...
				XHR.open('PUT', that.options.cropUrl);
				...
				$.ajax({
					url: that.options.cropUrl,
					data: JSON.stringify(formData),//formData.serializeArray().reduce(function(a, x) { a[x.name] = x.value; return a; }, {}),
					context: document.body,
					cache: false,
					//contentType: false,
