						...
						if (qi != null)
						{
							switch ((CqrsEventTypes)qi.Type)
							{
								...
								case CqrsEventTypes.UnitLocation:
									...
									{
										success = false;
										result = "Unable to parse UnitLocation object from CQRS data Exception: " + ex.ToString();
										message.Complete();
									}
								...
								case CqrsEventTypes.PushRegistration:
									...
									{
										success = false;
										result = "Unable to parse PushUri object from CQRS data Exception: " + ex.ToString();
										message.Complete();
									}
								...
								case CqrsEventTypes.UnitPushRegistration:
									...
									{
										success = false;
										result = "Unable to parse unit PushUri object from CQRS data Exception: " + ex.ToString();
										message.Complete();
									}
								...
								case CqrsEventTypes.ClearDepartmentCache:
									...
									{
										success = false;
										result = "Unable to parse department id  from CQRS data.";
										message.Complete();
									}
									break;
								case CqrsEventTypes.NewChatMessage:
									...
									if (qi != null && !String.IsNullOrWhiteSpace(qi.Data))
									{
										...
										{
											success = false;
											result = "Unable to parse NewChatNotificationEvent object from CQRS data Exception: " + ex.ToString();
											message.Complete();
										}
